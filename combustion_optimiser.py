...
T_target = 2000  # Target flame temperature in K
...
# Display results
print(f"Target Flame Temperature: {T_target} K")
print(f"Optimal OFR: {OFR_solution}")
print(f"Final Pressure: {final_pressure} Pa")
print(f"Gas Constant for Products: {R_products_solution} J/(mol·K)")
print(f"Ratio of Specific Heats: {k_products_solution}")
print(f"Density of Products: {rho_products_solution} kg/m³")
